...
import sys  
sys.path.append('D:\polyrnn-pp-pytorch\code')  
...
class OECRNN(nn.Module):
    def __init__(self, opts):
        super(OECRNN, self).__init__()

        self.opts = opts
        print ('Building OECRNN with opts:\n',opts)
    ...
    def forward(self,
        ...
        if self.mode == 'train_ce' or self.mode == 'test':
